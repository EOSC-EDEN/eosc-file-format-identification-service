...
The full FFIS specification lives in [`docs/specification.md`](docs/specification.md). It is the source of truth and should be edited directly in GitHub via pull requests.
